    ...
    var x = {
            ...
            initSlider: function(e) {
                ...
                elementorFrontend.config.experimentalFeatures.e_optimized_assets_loading ? o = setInterval(function() {
                    "undefined" !== elementorFrontend.utils.swiper && (new elementorFrontend.utils.swiper(e, Object.assign(t, n)).then(e => {}), clearInterval(o))
                }, 200) : new Swiper(e, Object.assign(t, n)), elementorFrontend.isEditMode() && elementor.channels.editor.on("change", function() {
                    e[0].swiper.update()
                })
            },
            getOptions: function(e) {
                var o = void 0 !== e.data("options") ? e.data("options") : {},
                    ...
                    p = p ? ".swiper-button-prev-" + o.unique : e.find(".swiper-button-prev"),
                    v = void 0 !== o.outsidePagination && "yes" === o.outsidePagination ? ".swiper-pagination-" + o.unique : e.find(".swiper-pagination"),
    ...
    var o = {
        ...
        initSwiperReinit: function(e) {
            var o = e.find("> .qodef-qi-swiper-container .swiper-slide-active"),
                ...
                t = (t.width(o.width()), t.css("top", o.height()), t = n.find(".swiper-slide").length, (o = i[0].swiper.params).loopedSlides = t, o.autoplay = "false", n[0].swiper.autoplay.stop(), i[0].swiper.destroy(), new Swiper(i, Object.assign(o)));
...
function(e) {
    ...
    var o = {
        ...
        initSwiperReinit: function(e) {
            ...
            let s = new Swiper(d, Object.assign(t)),
                l = new Swiper(r, Object.assign(o));
